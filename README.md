## Hi there 👋  
## Brijesh Lakhani this side 👨‍💻

### 💼 `Experienced MEAN Stack Developer (3+ Years)`  
### 🚀 `Tech Enthusiast | Backend Focused | Startup Mindset`

- 🔭 Currently building scalable full-stack solutions using **MongoDB, Express.js, Angular, and Node.js**
- ⚙️ Passionate about crafting performant APIs and clean backend architecture
- 🧠 Exploring advanced topics: Microservices, DevOps, and System Design
- 👨‍💻 Past Projects: Real estate platforms, caregiving systems, admin panels, and e-commerce APIs
- 🎯 Future Goals: Contribute to open-source, mentor junior devs, and grow product-led startups
- 📫 Reach me on: [My Socials](#🌐-socials)
- 🎮 Fun Fact: I'm either gaming, sketching, or scaling backend systems

![](https://komarev.com/ghpvc/?username=brijeshlakhani&style=for-the-badge&label=Profile+Visits)
